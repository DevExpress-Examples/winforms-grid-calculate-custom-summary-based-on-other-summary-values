...
Namespace Q273845
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class ProductsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddProductsRow(ByVal UnitPrice As Decimal, ByVal ProductName As String, ByVal UnitsInStock As Short, ByVal parentCategoriesRowByCategoriesProducts As CategoriesRow) As ProductsRow
				Dim rowProductsRow As ProductsRow = (CType(Me.NewRow(), ProductsRow))
				Dim columnValuesArray() As Object = { Nothing, UnitPrice, ProductName, UnitsInStock, Nothing}
				If (parentCategoriesRowByCategoriesProducts IsNot Nothing) Then
					columnValuesArray(4) = parentCategoriesRowByCategoriesProducts(0)
				End If
	...
	End Class
End Namespace
Namespace Q273845.nwindDataSetTableAdapters
	...
	Partial Public Class ProductsTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Products` WHERE ((`ProductID` = ?) AND ((? = 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `UnitsInStock` IS NULL) OR (`UnitsInStock` = ?)) AND ((? = 1 AND `CategoryID` IS NULL) OR (`CategoryID` = ?)))"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Products` SET `UnitPrice` = ?, `ProductName` = ?, `UnitsInStock` = ?, `CategoryID` = ? WHERE ((`ProductID` = ?) AND ((? = 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `UnitsInStock` IS NULL) OR (`UnitsInStock` = ?)) AND ((? = 1 AND `CategoryID` IS NULL) OR (`CategoryID` = ?)))"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT     ProductID, UnitPrice, ProductName, UnitsInStock, CategoryID" & Constants.vbCrLf & "FROM     " & "    Products"
		...
		Public Overridable Function Delete(ByVal Original_ProductID As Integer, ByVal Original_UnitPrice As Global.System.Nullable(Of Decimal), ByVal Original_ProductName As String, ByVal Original_UnitsInStock As Global.System.Nullable(Of Short), ByVal Original_CategoryID As Global.System.Nullable(Of Integer)) As Integer
			...
			If (Original_UnitPrice.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(2).Value = (CDec(Original_UnitPrice.Value))
			Else
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(4).Value = (CStr(Original_ProductName))
			End If
			...
			If (Original_CategoryID.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(8).Value = (CInt(Fix(Original_CategoryID.Value)))
			Else
		...
		Public Overridable Function Update(ByVal UnitPrice As Global.System.Nullable(Of Decimal), ByVal ProductName As String, ByVal UnitsInStock As Global.System.Nullable(Of Short), ByVal CategoryID As Global.System.Nullable(Of Integer), ByVal Original_ProductID As Integer, ByVal Original_UnitPrice As Global.System.Nullable(Of Decimal), ByVal Original_ProductName As String, ByVal Original_UnitsInStock As Global.System.Nullable(Of Short), ByVal Original_CategoryID As Global.System.Nullable(Of Integer)) As Integer
			If (UnitPrice.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(0).Value = (CDec(UnitPrice.Value))
			Else
			...
			Else
				Me.Adapter.UpdateCommand.Parameters(1).Value = (CStr(ProductName))
			End If
			...
			If (CategoryID.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(3).Value = (CInt(Fix(CategoryID.Value)))
			Else
				Me.Adapter.UpdateCommand.Parameters(3).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.UpdateCommand.Parameters(4).Value = (CInt(Fix(Original_ProductID)))
			If (Original_UnitPrice.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(5).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(6).Value = (CDec(Original_UnitPrice.Value))
			Else
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(8).Value = (CStr(Original_ProductName))
			End If
			If (Original_UnitsInStock.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(9).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(10).Value = (CShort(Fix(Original_UnitsInStock.Value)))
			Else
			...
			If (Original_CategoryID.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(12).Value = (CInt(Fix(Original_CategoryID.Value)))
			Else
	...
	Partial Public Class CategoriesTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
			Me._commandCollection(0).Connection = Me.Connection
			Me._commandCollection(0).CommandText = "SELECT     CategoryID, CategoryName" & Constants.vbCrLf & "FROM         Categories"
			Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
		End Sub
