...
namespace Q273845 {
    ...
    public partial class nwindDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public ProductsRow AddProductsRow(decimal UnitPrice, string ProductName, short UnitsInStock, CategoriesRow parentCategoriesRowByCategoriesProducts) {
...
namespace Q273845.nwindDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Products` WHERE ((`ProductID` = ?) AND ((? = 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `UnitsInStock` IS NULL) OR (`UnitsInStock` = ?)) AND ((? = 1 AND `CategoryID` IS NULL) OR (`CategoryID` = ?)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Products` SET `UnitPrice` = ?, `ProductName` = ?, `UnitsInStock` = ?, `CategoryID` = ? WHERE ((`ProductID` = ?) AND ((? = 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `UnitsInStock` IS NULL) OR (`UnitsInStock` = ?)) AND ((? = 1 AND `CategoryID` IS NULL) OR (`CategoryID` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Q273845.Properties.Settings.Default.nwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT     ProductID, UnitPrice, ProductName, UnitsInStock, CategoryID\r\nFROM     " +
                "    Products";
        ...
        public virtual int Delete(int Original_ProductID, global::System.Nullable<decimal> Original_UnitPrice, string Original_ProductName, global::System.Nullable<short> Original_UnitsInStock, global::System.Nullable<int> Original_CategoryID) {
        ...
        public virtual int Update(global::System.Nullable<decimal> UnitPrice, string ProductName, global::System.Nullable<short> UnitsInStock, global::System.Nullable<int> CategoryID, int Original_ProductID, global::System.Nullable<decimal> Original_UnitPrice, string Original_ProductName, global::System.Nullable<short> Original_UnitsInStock, global::System.Nullable<int> Original_CategoryID) {
            if ((UnitPrice.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((decimal)(UnitPrice.Value));
            }
            else {
            ...
            if ((Original_UnitsInStock.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((short)(Original_UnitsInStock.Value));
            }
            else {
